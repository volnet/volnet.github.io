...
> 如果一家企业具备了竞争优势，那么它将有机会拥有超额的利润，而且其他企业受到进入壁垒的保护，难以进入该领域。
>
> 企业享有竞争优势，通常由：规模经济效益、客户锁定所致，而这些取决于成本优势、技术优势（造成了成本优势）等。规模经济效益可以由缩小而不是扩大局部性来获得，比如特定的地理位置范围和特定的产品维度。
>
> 判断一个行业是否存在进入壁垒，可以考察这个行业里是否存在绝对占优的企业，相对市场份额是否长期保持稳定，企业是否获得了超过资本成本的丰厚利润，新进者是否容易进入，如果是的话，则多半存在进入壁垒。
>
> 不过竞争优势并非每个行业都有，对于大部分企业而言，所处的行业没有进入壁垒、自身也不具备竞争优势，那么是否就不值得进入了呢，答案是否定的，高效运营也可以带来媲美于结构性竞争优势的价值，这个非常依赖于优秀的管理者，以及他们的注意力。
...
为了实现合作，首先要避免竞争，可以局限在各自的细分市场中，而尽量不要侵犯到其他人的领域。其次是共享公共的一些资源，供应商、研发、技术、渠道、技术标准等。
...
通常考虑投资战略会以现金流为主线，而这又受到一系列因素的影响，导致难以做出正确的战略决策。本书会提供一个新的视角。
...
另外那些不使用现金并购而使用自己股票作为并购筹码的，通常都是因为其股票价格虚高。
...
投资更多是看资产能产生多少利润，以帮助你判断钱应该投向哪里。

> 1. 第一种方法是使用资产收益率，即净利润除以总资产。
>
> 2. 第二种方法是使用净资产收益率，即净利润除以资产负债表上股本的账面价值。这个指标衡量的是企业的所有者每投资1美元能获得多少美元的回报。
>
> 3. 第三种方法是使用投入资本回报率，这是我们在所需数据都可以得到的情况下优先采用的方法。
