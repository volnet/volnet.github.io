...
如果确实需要在容器内运行进程，可以使用：[nsenter](https://github.com/jpetazzo/nsenter)（适用于Docker 1.2或者更早的版本，Docker 1.3之后引入了`docker exec`命令，替换了它大部分功能），具体详见原文，或者[这里](http://www.open-open.com/lib/view/open1407721300457.html)。
