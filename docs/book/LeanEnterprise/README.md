...
- 跨职能组建不超过5～10人的团队（两个披萨法则）
    ...
    - 也有助于从这样的环境中获得一些领导力经验，利用留住人才

### 10.2 通过使命式指挥提升大规模开发的速率
...
但是要注意，在做问卷的时候要保证隐私和匿名，这样才可能收集到相对准确的信息。
...
- 探索领域：所有探索活动都归入运营费用。我们仍然需要团队明确他们想要在探索活动上消耗多少资源，但不应该要求他们每次想要尝试什么新的想法时都必须要得到进一步的资金审批，只要他们不超过预先定义的上限就行。
...
为了降低IT运维的负担，要将支持的工作交给开发他们的团队。在谷歌，产品上线初期是由产品团队负责，运行一段时间稳定后可以转为SRE，如果出现问题则再转回产品团队。
...
很多已经选择了开源软件产品作为技术组件的团队，会遭到运维部门的阻止，这时应该允许他们使用相关的组件，但需要他们自行承担运营商的风险和成本，做到谁开发谁运维。
...
避免对商业软件进行定制开发，尽量改变自己的业务流程去适应它。一旦改动，将很难停下来，当改变到了一定时候，运维将代价巨大。
...
组织必须不断地问自己：“我们存在的目的是什么？我们要如何管理才能提升组织的长期潜力，以及客户和员工的长期潜力？”对领导者来说，最重要的工作是建立本书所描述的高绩效文化。以这种方式，我们才能在设计理念与技术不断进步、社会与经济变更更加广泛的环境中繁荣发展。