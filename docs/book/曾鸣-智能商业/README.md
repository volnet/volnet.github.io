...
> 这是一本将互联网×商业讲得通透的书，把淘宝的核心逻辑抽丝剥茧讲给你听。作为几十年的老用户，你对淘宝一定不陌生，看这本书，你恐怕无法获得多少新知识，但也正因如此，你才能在这些看似理所当然的事物背后，找到商业演进的底层逻辑。
>
> 如果你是一名相似行业的从业者，你总能从这些体系化的信息里，产生很多和你自身业务的联想，进而推动你的业务，往十年甚至更长的时间看齐。
>
> 有阿里巴巴作为你的榜样，你大概会更脚踏实地地去推进你的业务，忘掉那些高大上的ppt，完美的商业计划书，未来不是设计出来的，而是在实践中演进出来的。
...
- 在线化：利用IoT等设备将人的五官进行延伸，实现在线化。利用计算机视觉实现视觉感知能力的延伸。利用AR技术切换真实和虚拟。
...
Web这个词同样是用来描述互联网，但是它和Internet不同，Internet体现的是网络基础设施，Web则更关注“互”这个层面的问题。
...
以淘宝为例，淘宝实现了整个零售体系在线化，相互协作。还有爱彼迎、快手、小红书、土巴兔，都在各自的领域形成了协作网络。
...
传统供应链不需要“面”和“体”这样繁复的网络，因为其目的是效率，如销量最大和成本最低。因此，传统商家会在整个价值链中尽其所能垂直整合上下游，以统一的标准、规格、质量，将“点”纳入其控制的价值链。互联网因其开放性，拥有高阶生态的丰富资源，无数“点”与“点”互动，迸发出的能力之大让传统、封闭的“线”望成莫及。这样的胜利，才是真正意义上的升维攻击。
...
创新平台包括创新中后台、平台协同机制，以及相适应的文化和环境。其中，创新中后台指的是创新所依赖的可共享的各种资源和基础设施的协作平台。中后台通常由许多不同层级、互相连通、形成复杂结构的子平台系统组成。

中后台最关键的特征是什么？

- 透明：形成正向激励的学习和竞争。
- 共创：每一次创新同样在中后台的平台上沉淀，智能、技术、经验、模式都以这种机制日益丰富，共同迭代，从而形成难以被其他平台超越的创新壁垒。
...
传统的KPI无法适应赋能的理念。领先的互联网企业经过这些年的摸索，充分利用了技术优势。我们看到了一些很有趣的代表未来的新方法，其中最核心的就是所谓的Matrix体系，我把它翻译成“目标矩阵”。

所谓目标矩阵就是用完全数据化的方式来测量、评估和监控创新。一方面，要对现有的业务实现完整的数据化；另一方面，要用数据化的方式定义一个企业试图优化的方向，也就是所谓的价值目标函数。

组织的目的是激发群体智慧，让人在一起能够完成更复杂、更艰巨的事业。我们所处的时代由网络协同和数据智能驱动，这是群体智慧和机器智能相互作用、协同演化的进程。未来的组织必将实现全新的协同方式，也必将时刻依赖数据和算法。

动态的目标体系作为组织的智能信息系统，及时同步了组织内外的数据和信息，让整个组织和创新的每个部分都能相互了解、共同配合，从而实现实时的全局调试和优化，确保组织和创新向着正确的方向迭代和演进。所以，我们看到外部的商业环境是由网络协同和智能生态推动的，组织内部实际上也在贯彻同样的网络协同和数据智能原则，做到内外一致。
...
淘宝从社区逐渐演化为多角色协同网络，原因有两个：

- 极具社区属性的“淘宝讲师”：淘宝讲师赋能淘宝卖家，帮助他们开店更容易。
- 平台做基础服务，第三方做增值服务：从店铺装修这个重要的场景下，淘宝第一次有意识地区分哪些是平台该做的事，哪些是“面”应该让利给“点”的事。淘宝只为卖家提供一个最基本的产品版本，如果卖家有更高的个性化需求，可以找独立的第三方来完成。

#### 数据智能的又一次胜利

从传统类目，到引入搜索，再到竞价排名，不同时期的需求催生了不同的产品，也催生了不同的协同角色。

网络扩张带来了新一轮的多元角色；越来越多的协同角色共同构筑并丰富了淘宝的协同网络；网络的日趋复杂化推动了关键数据智能技术的引入，提高了淘宝的网络效应；一个更为广大的网络，又有能力吸引更多的数据智能应用加入……循环往复，不断提升。

#### 平台是生长出来的

不仅是阿里，腾讯的发展也是如此。平台不是设计出来的，而是自我演化的产物。市场和环境的瞬息万变，企业发展的方向如果不能及时调整，可能根本就无法生存，更遑论未来的发展。

### 15 新品牌：网红时代的品牌打造

#### 网红电商：三级支撑下的爆炸性商业机会

在淘宝上涌现出一些独特的新店铺，它们奇特的销量曲线和飞快的成长速度，引起了平台的高度重视。对网红电商进行进一步的剖析，会发现，网红电商其实充分地利用了三个不同类型的平台级服务：

- 一是淘宝等电商平台，提供工具和系统等
- 二是各类社交媒体平台，如微博、微信，提供沟通交流、需求收集、评价反馈等
- 三是快速反应供应链平台，提供快速的满足需求的能力

#### 品牌互联网化的创新打法

研究网红现象背后的根本性变化，我将其总结为市场和品牌的互联网化，而这无疑是之前两个大浪潮（广告互联网化和零售互联网化）的延续。

- 品牌的打造方式不同：传统是从战略、产品、品牌定位、广告规划、媒体投放、传播、形成品牌、形成有效销售。网红品牌是网红和“粉丝”共同运营和创造的，消费者不需要被说服，因为他们早已认同了该网红品牌。
- 品牌生命力不同：网红品牌是粉丝共同运营和创造的，即便有瑕疵，粉丝会容忍甚至鼓励。
- 品牌转化率不同：实际转化率比传统品牌高很多。
...
1. 在“互联网+”的语境下，所有这些努力都把互联网方法视为工具和手段，用于提升原有体系中某些环节或局部的效率，目标指向是优化，而非模式的重构。
2. 传统企业并未意识到，互联网不仅仅是与用户的简单连接，其内核是互动，是数据驱动的互动，“互联网+”仅有连接的“形”，而没有数据和算法的“魂”，相当于在公路上跑着的马车，其局限性一目了然。

#### “互联网×”：新时代的开创者

和电的发明和应用一样，互联网也是这样一种新技术，互联网的下半场，就是一个利用互联网这种通用技术的大创新，全面重构传统产业的过程。一些观察和思考提供了一些借鉴和参考：

- 产业升级、互联网化、网络协同和数据智能的方法进行重构，三浪叠加才有机会进入下半场。
- 上半场的互联网经验对下半场不一定有用，愿意从头做基本工作、有共同信仰的人，更有可能成功。
- 这一轮“互联网×”的创业需要更长的痛苦的孕育期，而且无法用资本的方法催生，新的创业者要有足够的耐心。

结语 新文明：感受未来已来
----------------------------------------

虽然人类的大脑是自然界已知生物中演化最快的，但人类文明的演进，更多的是源于群体合作的快速发展所创造的巨大价值，而不是个体的进化。

合作的演化建立在技术和制度两个基础之上。

互联网和数据时代，就是创造力的时代。未来，无论是工作还是生活，将由人类的想象力驱动向前，一切都将围绕创造展开。
