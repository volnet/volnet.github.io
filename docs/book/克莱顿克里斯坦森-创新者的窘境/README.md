...
> 领先企业之所以被新兴企业颠覆，原因就在于要求企业追求更高的利润率、增长率、关注客户需求，也正是这些帮助领先企业领先的优秀管理做法，在天然上让他们容易忽视破坏性技术的存在。和延续性技术不同，延续性技术要求我们在性能上更好地满足客户需求，提供了更多的性能，会让企业不断从低端市场进入高端市场，并赚取更多的利润。但破坏性技术的出现通常无法满足市场主流客户的期待，以致于从市场营销、财务的角度无法在成熟企业内部分配到足够的资源，而无法得到发展。但破坏性技术实际上可能可以满足新兴市场的需求，随着市场的开拓和性能改善，破坏性技术的各项性能会逐渐达到原有市场客户的要求，导致原有技术被淘汰。因为延续性技术在初期发展的过程中建立了自己的壁垒，所以后期传统技术为代表的领先企业想要再切换到破坏性技术上，则非常难。导致他们可能最终选择退守更高端的市场、打价格战、或者让客户接受不断增加的产品性能。破坏性技术和传统企业管理的理念有自然矛盾，但不是不可调和的，企业的管理者在理解了破坏性技术成功的路径后，可以做出应对策略来达成企业战略。
>
> 这本书的中文译本（中信出版社版）翻译地一般，看起来有点晦涩。

[美]克莱顿·克里斯坦森 著

胡建桥 译

![封面](contents/wx-cover-235-1.png)
...
> 当产生性能过度供给现象时，破坏性技术的机遇也呼之欲出，然后开始从价值网络的下方冲击成熟市场。当性能过度供给给破坏性技术带来威胁或机遇时，这还会导致产品市场的竞争基础发生根本性变化。

客户不再关注不同产品之间的性能差异，性能增加的溢价趋近于零。客户更关注价格而不是产品特性。客户对于产品的关注重点沿着功能性、可靠性、便捷性、价格，四个阶段不断变化。
...
在财务软件市场上，Quicken公司的个人财务软件和面向企业的传统财务软件截然不同，他们不要求使用者具备专业的财务知识，并且不是通过咨询财务专家的意见来设计产品，而是观察用户如何使用财务软件的，因此在个人财务软件市场上大获成功。大部分的用户事实上并不具备财务知识，一些个体经营者都是自行管理财务，因此一款不需要预设财务知识和审计流程的财务软件更符合他们使用的需要。与此相反，市场上的财务软件的领头企业，他们则向更加专业功能更加丰富的财务软件方向努力。

在胰岛素注射市场，礼来公司耗费巨资研发更高纯度的胰岛素以解决特别罕见的胰岛素免疫不适用患者的需求，而诺和（Novo）公司则发明了一种简单注射的针头，解决了注射胰岛素很麻烦的问题，因此大获成功。

性能过度供给的企业可选的战略方法，主要有三个：

1. 去服务更高端的市场，获取更高的利润，即将延续性技术的轨线提升到市场的更高级别，从而在更简单、更便捷或是更便宜的破坏性方法出现时，最终选择放弃更低端的客户。
2. 根据市场调整产品策略，即在以一个特定的市场级别上，时刻与客户的需求保持步调一致，从而紧跟每一轮竞争基础的变革浪潮，比如推出针对低端市场的廉价产品。
3. 提高客户的需求，即利用市场营销计划来加深市场轨线的坡度，使客户的需求能够跟上技术人员所能提供的性能改善速度。

这些成功的战略实施者有一个共同的特点，那就是不管是有意识的还是出于本能，他们都深刻理解了客户的需求曲线和技术人员的供给曲线。到目前为止，理解这些曲线是他们获得成功的关键。但能够长期做到这一点的企业屈指可数。

### 第10章 假如让你负责电动汽车项目

> 在一个熟悉但充满挑战的环境里，管理者怎样才能通过提出一系列问题（这些问题可能会引出一个合理且实用的答案）来转换他们看待类似问题的思维方式。

如何通过破坏性技术切入一个新的市场呢？

1. 确认新技术是否为破坏性技术。
    - 传统车企：电动汽车是否是破坏性威胁？
        - 确定主流市场的需求。观察客户如何使用产品，看客户关注哪些功能。
            - 续航里程
            - 加速性能（安全）
            - 多种选择
            - 结论：电动汽车在以上重点关注的功能上，还都逊色于传统汽油汽车。
        - 性能改善曲线未来是否能够与需求轨线交汇？（性能改善后是否能满足需求）
            - 需求受政策法规和道路特性等限制，相对比较平缓。（即续航需求差不多、加速要求差不多等）
            - 性能改善速度约每年2%~4%。
            - 结论：随着电动车技术的成熟，未来会逐渐满足市场需求。
        - 结论：因此电动汽车是一项破坏性技术。（而不是因为它的环保特性）
    - 传统车企：电动汽车是否能实现盈利增长？制定市场营销战略，领导我的企业进入一个可以率先使用电动汽车的、正统的、没有补贴性质的市场。以下是三大原则：
        - 找到需要这项技术的市场，而不是参考主流市场的判断。
        - 通过真正进入市场，通过测试和探索，通过反复尝试，通过向真正愿意掏腰包的实际客户销售实际的产品，我们能够从中得到些什么。——不是通过补贴和强制性法规维持市场出现，而是要找到真正的需求。
        - 必须是学习计划而不是一个实施计划，要承认过程中会找错方向，需要及时调整并预留好足够的资源。
2. 设计市场营销手段打开市场：
    1. 找到匹配的市场。
    2. 找到真正的市场需求。
    3. 不断地学习并纠错，而不是一意孤行。
3. 制定产品战略
    设计产品的时候，遵循3个原则：
    1. 必须简单、可靠和便捷。——抓住产品的本质即可。
    2. 产品的设计、生产和纠错应支持：小批量试错、快速迭代。
    3. 确定一个较低的定价点，这样才能够推向市场。
4. 制定技术战略

    破坏性技术并不是一项新技术，而通常是将不同的经过验证的成熟技术重新组合起来。我们的技术规划不能要求这一项目在技术上取得任何突破。

5. 制定市场战略

    除了有破坏性的技术，还需要寻找或创造新的经销网络。

6. 成立独立公司

    成立一个独立的公司，并设立一种新的机构价值观和文化，同时也不要拥有过多的财富和资产，要让新公司的员工有足够的动力去工作。

### 第11章 本书观点回顾

> 在单纯追求利润和增长率的过程中，一些伟大企业的伟大管理者因为使用了最佳管理技巧而导致了企业的失败。但企业不应该仅因为这些管理技巧无力应对破坏性技术所带来的威胁，而放弃这些曾使它们在主流市场大放异彩的能力、组织结构和决策流程。

本章针对整本书的观点做个回顾：

1. 市场和技术不一定是同步发展的，存在时差，现在没有使用场景的技术未来也许有。如果技术超前了，我们不要指望客户来教我们怎么用，轨线图有助于我们分析各种状况，了解企业面临的形势。
2. 创新管理反映了资源分配流程。创新成功的一个条件是有足够的资源用于发展，如果资源分配流程都是瞄准利润率这样的财务指标，很可能导致创新失败。
3. 破坏性技术不一定会匹配成熟市场，导致现有市场和技术的不匹配，应该为破坏性技术找到合适的市场。
4. 一家成熟的企业是在特定的价值网络中形成的，其资源、流程、价值观都与特定的价值网络紧密相关，而新兴市场可能需要一个新的结构来匹配新的价值网络。
5. 新兴市场可能无法预测也无法市场调研，只能进行不断试错，要接受失败并保持学习的态度，加深对新市场的理解。
6. 技术战略也不应该是一成不变的，破坏性技术具有先发优势要保持领先，延续性技术通常没有这方面的优势。
7. 因为成熟大企业的“理智”让他们追求利润更高的市场，以至于在破坏性技术出现的前期，有一个广泛存在的壁垒来保护破坏性技术能茁壮成长，这也给了创业者和投资者以机会。但如果传统企业意识到破坏性技术的这些特点，也是有机会运用破坏性技术来获得更多回报的。
